...
│  ├─ core-common/          # Result, Error, Constants 등 베이스 타입
│  ├─ core-ui/              # BaseFragment/Adapter, 공통 UI 헬퍼
│  ├─ core-network/         # Retrofit/OkHttp, Interceptor, 네트워크 유틸
...
│
├─ test/                    # 공용 테스트 유틸 (Fake/Rule/Fixture)
│
